...
function OPDRegistrationForm() {
  ...
  const onSubmit = (formData) => {
    const updatedFormData = { ...formData, import React, { useState } from 'react';
    import { Link } from 'react-router-dom';
    import axios from 'axios';
    import Navbar from '../common/Navbar';
    import '../../styles/OPD.css';
    ...
    export default OPDRegistrationForm;age: Number(formData.age) };
      ...
      <section className="form-container">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="opd-registration-form">
          ...
          <div className="form-group">
            ...
            <input
              type="number"
              {...register("age", { required: "Age is required", min: { value: 1, message: "Age must be a positive number" } })}
              placeholder="Enter your age"
            />
          ...
          <div className="form-group">
            ...
            <input
              type="tel"
              {...register("contact", { required: "Contact number is required", pattern: { value: /^\d{10}$/, message: "Contact number must be 10 digits" } })}
              placeholder="Enter your contact number"
            />
