    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-100 to-blue-50">
      <header className="relative text-black py-16 sm:py-24 md:py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-100 to-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            <Button primary to="/registerOPD">Book Appointment</Button>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="mb-20 relative">
          ...
          >
            <h3 className="text-xl font-semibold mb-4  text-blue-700">Patient Flow Analysis</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            >
              <h3 className="text-xl font-semibold mb-4 text-blue-700">Resource Allocation</h3>
              <motion.img
                src="data2.png"
