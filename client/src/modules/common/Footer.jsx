...
import { FaHome, FaGithub, FaRegCopyright, FaDiscord, FaLinkedinIn, FaArrowUp } from 'react-icons/fa';
...
const Footer = () => {
  ...
  useEffect(() => {
    ...
    const socialMedia = [
        { Icon: FaGithub, link: 'https://github.com/Luson045/medi-connect', color: '#333' },
    ...
    <div className='container mx-auto'>
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
            ...
            <div className="space-y-4">
                <Link to="/" className="flex items-center gap-2 group transition-all duration-300 ease-in-out transform hover:scale-105">
                    ...
                    <img src = "favicon.png" className="h-10 w-10 transition-transform duration-300 group-hover:rotate-6" alt="AgroTech AI Logo" />
                ...
                The Med Space platform simplifies hospital management with efficient queuing models, lab test, OPDs, and inventory management for medicines and consumables.
                </p>

                <div className='inline-flex w-48' style={{ marginTop: '4rem'}}>
                    <img src="/google.png" alt="" className="google-translate" style={{ display: 'block', width: '30px', marginLeft: '0' }} />
                    <GoogleTranslate />
                </div>
        ...
        <p className="font-bold bg-gradient-to-r from-[#b6dbfc] to-[#b6dbfc] bg-clip-text text-transparent group-hover:from-[#133859] group-hover:to-[#b6dbfc] transition-all duration-300">DISCLAIMER</p>
        ...
        <div className='mt-8 pt-8 border-t border-[#b6dbfc]/30 text-center'>
            <p className='flex items-center justify-center text-sm'>
                <FaRegCopyright className='mx-1' /> {currentYear} All Rights Reserved 
